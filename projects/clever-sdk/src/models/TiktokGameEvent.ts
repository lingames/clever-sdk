 ...
 */
export type TiktokEventParams<T extends TiktokGameEvent> = T extends TiktokGameEvent.LOADING_COMPLETE
    ? LoadingCompleteParams
    : T extends TiktokGameEvent.COMPLETE_SECTION
      ? CompleteSectionParams
      : T extends TiktokGameEvent.GAIN_CREDITS
        ? GainCreditsParams
        : T extends TiktokGameEvent.USER_LEAVE
          ? UserLeaveParams
          : Record<string, any>;
